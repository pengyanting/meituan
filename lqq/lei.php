        ...
        <div class="sm_nav">
            <div class="nav_inner fix">
                <div class="left_nav">
                    ...
                    <a href="javascript:;" class='title'>按药用部位分类</a>
                </div>
            </div>
            <div class="ct_search clearfix">
                <div class="search clearfix">
                    <label for="">搜索药品：</label>
                    <input type="text" placeholder="药品名称">
...
<script>
    $(function () {
        ...
        //获取一级分类
        var sql="select * from lei where parentid="+GetQueryString('parentid')
        function search(sql) {
            $.ajax({
                type: 'POST',
        ...
        $('.search img').click(function () {
            ...
            sql="select * from lei where parentid="+GetQueryString('parentid')
            if (title != '') {
