...
<body>
    ...
    <div class="cour_detail">
        <div class="banner">
            <div class="crumbs  w1180">
                课程中心/课程详情
            </div>
            <div class='coourse_info'>
                <h1></h1>
                <div class='study_btn'><a href="javascript:;" style='color:#fff;'>关注</a></div>
                <ul class='clearfix'>
                    <li></li>
                    <li></li>
                    <li></li>
        ...
        <div class="all_info  w1180">
            ...
            <div class="panel-list">
                ...
                <div class="panel hide" data-cps-role="tabpannel">
                    ...
                    <div class="mulu-box">
                        <!--<div class="mulu-list">
                            ...
                            <div class="mulu-con">
                                <ul>
                                    <li>1. 深入参与大数据分析产品的设计、开发、测试等工作。<span>去学习</span></li>
                                    <li>2. 深入参与深度分析产品的设计、开发、测试等工作。<span>去学习</span></li>
                                    <li>3. 完善并优化现有大数据分析产品。<span>去学习</span></li>
                                    <li>4. 完善并优化现有深度分析产品。<span>去学习</span></li>
                                </ul>
                            </div>
                        </div>-->
                    </div>
                ...
                <!--笔记-->
                <!--<div class="panel hide" data-cps-role="tabpannel">
                    亲，你还没有登陆哦，请登录之后再记录笔记。<a href="login.php">去登陆</a>
                </div>-->
                <!--任务-->
                <div class="panel hide" data-cps-role="tabpannel">
                    <div class='nologin hide'>
                    ...
                    <div class="task-list clearfix">
                        <!--<div class="task-item">
                            <a href="/test/wtjzg/{{$value.taskId}}">
                                <div class="task-info t-wtj">
                                    <div class="tit">
                                        <h3 class="title">taskName</h3>
                                        <span class="label b_label">taskTypeName</span>
                                        <span class="label p_label">textPaperNum道题</span>
                                    </div>
                                    <p class="info">courseName</p>
                                    <p class="time_num">本学期第courseNum次课</p>
                                    <div class="time">
                ...
                <div class="panel hide" data-cps-role="tabpannel">
                    ...
                    <div class='discus'>
                        ...
                        <div class='discus_box'>
                            <!--<div class='discus_item'>
                                <div class='discus_img'><img src="img/noavatar.png" alt=""></div>
                                <div class='discus_con'>
                                    <p class="username">lemon</p>
                                    <p class='con'>听不懂的可以留着这个坑以后来补，前端安全很重要的</p>
                                    <p class='time'>时间：2017-03-31</p>
                                </div>
                            </div>-->
                        </div>
                    </div>
...
<script>
    $(function () {
        ...
        $(".mulu-box").on('click', 'li', function () {
            ...
            var idArr = [];
            if (!userid) {
                firstTaskVideo(id, localStorage.getItem('username'), localStorage.getItem("id"),
                    courseId);
                return;
            }
            idArr = userid.split(",");
