...
/***/ function(module, exports, __webpack_require__) {
	...
	var tklist = __webpack_require__(10);
	...
	*/
	...
	;(function(window, document) {
	    ...
	    var utils = {
	        ...
	        /**
	         * 获取 url 后的参数，使用方法：utils.param(param);
	         * @param  {String} name 参数名称
	         * @return {String}      有参数返回参数的值，没有返回 null
	         */
	        ...
	        dateFormat: function (date, format) {
	            ...
	            format = format.replace(/([yMdhmsqSw])+/g, function (all, t) {
	                ...
	                if (v !== undefined) {
	                    ...
	                    return chineseWeekNames[date.getDay()];
	                }
	                return all;
	            });
	            return format;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(f) {
	    ...
	    var Validator = function(formName, options) {
	        ...
	        // HTML5 添加 novalidate
	        if(this.form.hasOwnProperty('nodeType'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Validator = __webpack_require__(8);

	$(function(){
		//登录验证
		var login_validator = new Validator('login_form', {
		    fields: {
		        username: {
		            rules: 'required | max_length(32)',
		            messages: "用户名不能为空 | 不能超过 {{param}} 个字符"
		        },
		        password: {
		            rules: 'required',
		            messages: "密码不能为空"
		    ...
		    callback: function(event) {
		    	// 阻止表单提交
		    	login_validator.preventSubmit();
		    	$('.re_error').text('');
		        // 回调函数
		        var sbtn = $('#login_btn');
		        if(sbtn.hasClass('submitting'))
		        	return;
		        sbtn.addClass('submitting').val('登录中...');
				$.ajax({
					url:'/login',
					type: 'POST',
					dateType: 'JSON',
					data: {
						"loginAccount": $('#username').val(), //登录账号
						"password": $('#password').val(), //密码
						"accountSource": $('#accountSource').val(), //登录帐号来源
						"loginChannel": $('#loginChannel').val(),	//登录渠道
						"verificationCode": $('#imgcode').val(),	//验证码
						"type": $('#type').val() 					
					},
					success: function(data){
						if(data.resultCode == 0){
							...
							sbtn.removeClass('submitting').val('登录');
							$('.re_error').text(data.result);
							$('.valid_img').click();
						}
					}
				})
		...
		$('#login_form').find('input').blur(function(){
			$(this).next('.valid-error-message').remove();
		})
	})
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*TMODJS:{"version":3,"md5":"afd4f03760fe8e6e94cf9bfdafaaa82f"}*/
	var template=__webpack_require__(11);module.exports=template("task-list",function(a){"use strict";var b=this,c=b.$helpers,d=b.$each,e=a.taskInfoList,f=(a.$value,a.$index,b.$escape),g="";return d(e,function(a){g+=' <div class="task-item"> ',"01"==a.status?(g+=' <a href="/test/uncommit/',g+=f(a.taskId),g+='"> '):"02"==a.status?(g+=" ","10130002"==a.taskTypeId?(g+=' <a href="/test/wpyzg/',g+=f(a.taskId),g+='"> '):"10130003"==a.taskTypeId&&(g+=' <a href="/test/wpysx/',g+=f(a.taskId),g+='"> '),g+=" "):"03"==a.status&&(g+=" ","10130002"==a.taskTypeId?(g+=' <a href="/test/ywczg/',g+=f(a.taskId),g+='"> '):"10130003"==a.taskTypeId?(g+=' <a href="/test/ywcsx/',g+=f(a.taskId),g+='"> '):(g+=' <a href="/test/complete/',g+=f(a.taskId),g+='"> '),g+=" "),g+=' <div class="task-info"> <div class="tit"> <h3 class="title">',g+=f(a.taskName),g+='</h3> <span class="label b_label">',g+=f(a.taskTypeName),g+='</span> <span class="label p_label">',g+=f(a.textPaperNum),g+='\u9053\u9898</span> </div> <p class="info">',g+=f(a.courseName),g+='</p> <p class="time_num">\u672c\u5b66\u671f\u7b2c',g+=f(a.courseNum),g+='\u6b21\u8bfe</p> <div class="time"> <span class="st">',g+=f(c.dateFormat(a.releaseTime,"MM-dd hh:mm")),g+='</span> <span class="region-line"></span> <span class="et">',g+=f(c.dateFormat(a.endTime,"MM-dd hh:mm")),g+='</span> </div> </div> <i class="t-status ',"01"==a.status?g+="t-wtj":"02"==a.status?g+="t-wpy":"03"==a.status?g+="t-ywc":"04"==a.status&&(g+="t-ygq"),g+='"> </i> ',"04"!=a.status&&(g+=" </a> "),g+=" </div> "}),new String(g)});
...
/***/ function(module, exports) {
	...
	/*TMODJS:{}*/
	!function(){function a(a,b){return(/string|function/.test(typeof b)?h:g)(a,b)}function b(a,c){return"string"!=typeof a&&(c=typeof a,"number"===c?a+="":a="function"===c?b(a.call(a)):""),a}function c(a){return l[a]}function d(a){return b(a).replace(/&(?![\w#]+;)|[<>"']/g,c)}function e(a,b){if(m(a))for(var c=0,d=a.length;d>c;c++)b.call(a,a[c],c,a);else for(c in a)b.call(a,a[c],c)}function f(a,b){var c=/(\/)[^\/]+\1\.\.\1/,d=("./"+a).replace(/[^\/]+$/,""),e=d+b;for(e=e.replace(/\/\.\//g,"/");e.match(c);)e=e.replace(c,"/");return e}function g(b,c){var d=a.get(b)||i({filename:b,name:"Render Error",message:"Template not found"});return c?d(c):d}function h(a,b){if("string"==typeof b){var c=b;b=function(){return new k(c)}}var d=j[a]=function(c){try{return new b(c,a)+""}catch(d){return i(d)()}};return d.prototype=b.prototype=n,d.toString=function(){return b+""},d}function i(a){var b="{Template Error}",c=a.stack||"";if(c)c=c.split("\n").slice(0,2).join("\n");else for(var d in a)c+="<"+d+">\n"+a[d]+"\n\n";return function(){return"object"==typeof console&&console.error(b+"\n\n"+c),b}}var j=a.cache={},k=this.String,l={"<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","&":"&#38;"},m=Array.isArray||function(a){return"[object Array]"==={}.toString.call(a)},n=a.utils={$helpers:{},$include:function(a,b,c){return a=f(c,a),g(a,b)},$string:b,$escape:d,$each:e},o=a.helpers=n.$helpers;a.get=function(a){return j[a.replace(/^\.\//,"")]},a.helper=function(a,b){o[a]=b},module.exports=a,a.helper("dateFormat",function(a,b){a=new Date(a);var c=["\u661f\u671f\u65e5","\u661f\u671f\u4e00","\u661f\u671f\u4e8c","\u661f\u671f\u4e09","\u661f\u671f\u56db","\u661f\u671f\u4e94","\u661f\u671f\u516d"],d={M:a.getMonth()+1,d:a.getDate(),h:a.getHours(),m:a.getMinutes(),s:a.getSeconds(),q:Math.floor((a.getMonth()+3)/3),S:a.getMilliseconds()};return b=b.replace(/([yMdhmsqSw])+/g,function(b,e){var f=d[e];return void 0!==f?(b.length>1&&(f="0"+f,f=f.substr(f.length-2)),f):"y"===e?(a.getFullYear()+"").substr(4-b.length):"w"==e?c[a.getDay()]:b})})}();
