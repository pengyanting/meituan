<template>
    <div>
        ...
        <div class="containers">
            <div class="city">
                <div class='currentPos  city-list'>
                    <span class="city-letter">当前定位城市</span>
                    <p>{{currentPos}}<span @click='reposition'>重新定位</span></p>
                </div>
                <div class="city-list" v-for='item in cityList' :key='item'>
                    <span class="city-letter" id="A1">{{item.id}}</span>
                    <p :data-id='listItem.id' v-for='listItem in item.list' @click='clickCity(listItem)'>{{listItem.name}}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        methods: {
            reposition() {
                ...
                myCity.get(function (result) {
                    vm.currentPos = result.name
                });
            },
            clickCity(obj){
              this.$emit('selectCity',obj)
            }
        }
    }
...
<style lang='sass' scoped>
    ...
    .city-list .city-letter {
        ...
        width: 100%;
        color: #656565;
        bordre-bottom: 1px solid #dcdcdc;
    }
